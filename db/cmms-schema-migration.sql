...
CREATE TABLE IF NOT EXISTS workpermit (
  ...
  KEY ix_workpermit_site (company_id, site_id),
...
CREATE INDEX ix_inspection_dates ON inspection (company_id, site_id, planned_date, actual_date);
CREATE INDEX ix_workorder_dates ON workorder (company_id, site_id, planned_date, actual_date);
